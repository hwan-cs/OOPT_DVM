...
public class DialogPaymentConfirmation extends JDialog { // 결제 의사 확인 다이얼로그
    ...
    public void initOther() {
        this.balanceLabel.setText("현재 잔액: " + String.valueOf(dvm.getCard().getBalance())); // 잔액 보려고 넣은 임시 코드
