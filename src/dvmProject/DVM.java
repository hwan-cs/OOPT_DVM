...
public class DVM 
{
	...
	private int id;
	private int state;
	private int[] address; // address가 String 타입? int[] 타입이어야 하는거 아닌가?
	...
	{
		this.id = 3; //임의로 설정
		this.address = new int[] {12, 47};  //임의로 설정
		basicSetting();
	}
	...
	public String[] calcClosestDVMLoc(List<String[]> confirmedDVMList) 
	...
	public boolean checkOurDVMStock(String drinkCode) 
	{ // 우리 DVM(=DVM3)의 재고 확인
		// TODO implement here
		return false;
	}
